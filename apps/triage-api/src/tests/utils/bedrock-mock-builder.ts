import type * as bedrock from '../../services/nova-clients/bedrock';

export const setupPipelineBedrockMocks = (bedrockMock: typeof bedrock) => {
    (bedrockMock.invokeNovaLite as any)
    ...
    (bedrockMock.invokeNovaPro as any)
        .mockResolvedValueOnce(JSON.stringify({
            clusters: [
                {
